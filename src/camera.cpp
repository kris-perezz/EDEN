...
/*const glm::mat4 &Camera::getViewMat() const { return viewMatrix; }*/
...
void Camera::processMouseMovement(float xoffset, float yoffset) {
  ...
  // Camera can NOT look further down than below
  if (pitch < -89.0f) {
    pitch = -89.0f;
  }
...
/*                              glm::vec3 up) {*/
/**/
/*  // three basis vectors in each direction(all orthogonal to eachother)*/
